...
// Nous effectuons le test d'affichage de l'IHM
public class TestFenetre extends JFrame implements ActionListener{
	...
	public TestFenetre() throws ParseException, AtomeDejaAjouterException,AtomeInexistantException {
	...
	public static void main(String[] args) throws ParseException, AtomeDejaAjouterException,AtomeInexistantException {
		TestFenetre appliFenetre = new TestFenetre();
